...
function dwqa_plugin_init(){
    ...
    /* Sample Posttype Registration */
    $sample_labels = array(
        'name' => _x('Code Samples', 'post type general name'),
        'singular_name' => _x('Code Samples', 'post type singular name'),
        'add_new' => _x('Add New', 'theme'),
    ...
    register_post_type( 'funk-sample', $samples );
