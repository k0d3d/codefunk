...
?>
    ...
    <div id="answer-<?php echo $answer_id; ?>" <?php post_class(); ?>>
        ...
        <div class="funk-samples">
            <!-- //include code-samples template -->
            <?php include_once 'code-samples.php'; ?>
            <?php
                if (is_user_logged_in()):
            ?>
                <h5 data-answer-id="<?php echo $answer_id; ?>" class="add-sample-title">
                    <i class="fa fa-plus"></i>
                    Add Code Sample
                </h5>
                <div id="sample-answer-postbox-<?php echo $answer_id; ?>" class="postbox">

                    <form id="sample-form-<?php echo $answer_id; ?>" class="new_sample_editor" name="new_post" method="post" action="">

                        <p><label for="title">Codename</label><br />
                        <input type="text" id="sample_title_<?php echo $answer_id; ?>" class="title-input" value="" size="20" name="title" placeholder="e.g hiphop.php"/></p>

                        <p><label for="code_sample">Code Sample</label><br />
                        <div id="code-sample-editor-<?php echo $answer_id; ?>" name="code_sample" class="code-sample-input"></div>
                        </p>

                        <input type="hidden" name="post_type" value="funk-sample" />
                        <input type="hidden" name="answer_id" value="<?php echo $answer_id; ?>" class="answer-id-hidden"/>
                        <input type="hidden" name="action" value="post" />

                        <p>
                            <button class="btn btn-success submit-sample-btn" type="submit" data-answer-id="<?php echo $answer_id; ?>">Add this Sample</button>
                        </p>
            ...
            <?php else: ?>
                <h5 class="">Login To Add Code Sample</h5>
            <?php endif; ?>
        </div>
        <div class="dwqa-comments">
            <h6 style="color: #949494">Answer Comments</h6>
